...
Video.create(title: "The Wire", description: "One of the best TV shows ever made.", large_cover_url: "wire.jpg", small_cover_url: "wire_small.jpg", category_id: 3)
Video.create(title: "Sopranos", description: "A very entertaining and well made TV show.", large_cover_url: "sopranos.jpg", small_cover_url: "sopranos_small.jpg", category_id: 1)
Video.create(title: "The Simpsons", description: "A classic that needs no description.", large_cover_url: "simpsons.jpg", small_cover_url: "simpsons_small.jpg", category_id: 2)
